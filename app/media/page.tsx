                ...
                <main className="flex-1 overflow-y-auto bg-slate-50/50 dark:bg-gray-950/50">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                        ...
                        <div className="mb-8">
                            ...
                            <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2">Media Gallery</h1>
                            <p className="text-gray-600 dark:text-gray-400">Browse our collection of images and videos</p>
                        </div>
